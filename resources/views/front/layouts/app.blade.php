...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="fs-4 navbar-brand" href="{{ route('home') }}">BOOK BANK</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @if (!Auth::check())
                <a class="btn btn-outline-primary me-2" href="{{ route('account.registration') }}" type="submit">Registration</a>
                <a class="btn btn-outline-primary me-2" href="{{ route('account.login') }}" type="submit">Login</a>
                @else
                @if(Auth::user()->role =='admin')
                <a class="btn btn-outline-primary me-2" href="{{ route('admin.admindashboard') }}" type="submit">Admin</a>
                @endif
                <a class="btn btn-outline-primary me-2" href="{{ route('account.centers') }}" type="submit">Account</a>
                <a class="btn btn-outline-primary me-2" href="{{ route('account.logout') }}" type="submit">LogOut</a>
                @endif			
				{{-- <a class="btn btn-outline-primary me-2" href="login.html" type="submit">Register</a>
				<a class="btn btn-primary" href="post-job.html" type="submit">Donate a book</a> --}}
			</div>
		</div>
	</nav>
</header>
