                    ...
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            ...
                            <div style="margin-top: -10px;">
                                <a href="{{ route('front.myReturnReq') }}" class="btn btn-primary">My Returned Books</a>
                            </div>
                        </div>
                                    ...
                                    @php $counter = 1; @endphp <!-- Initializing the counter -->
                                        @foreach ($books as $book)
                                            <tr>
                                                ...
                                                <td>{{ $book->status }}</td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="{{ url('return_book', $book->id) }}">Return</a> <!-- Issue button -->
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
