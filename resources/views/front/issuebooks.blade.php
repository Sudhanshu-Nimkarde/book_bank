                ...
                <div class="card border-0 shadow mb-4 p-3">
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3 class="fs-4 mb-1">Issue Books</h3>
                            </div>
                            <div style="margin-top: -10px;">
                                <a href="{{ route('front.myIssueReq') }}" class="btn btn-primary">My Issue Requests</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($books as $book)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="{{ url('issue_books', $book->id) }}">Issue</a> <!-- Issue button -->
                                            </td>
                                        </tr>
                                    @endforeach
                                    @endif
